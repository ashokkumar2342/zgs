        ...
        <div class="box">
                    ...
                    <div class="row">
                        ...
                        <dir class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::select('class', $classes, @$classFee->class_id, ['class'=>'form-control']) !!}
                                </div>
                            </div>
                        </dir>
                    </div>
                     ...
                     <div class="col-lg-4">                         
                       <div class="form-group">
                        {{ Form::label('admission_form_fees','Admission Form Fees (In Rs.)',['class'=>' control-label']) }}
                        {{ Form::number('admission_form_fees',@$classFee->admission_form_fee,['class'=>'form-control required']) }}
                        <p class="text-danger">{{ $errors->first('admission_form_fees') }}</p>
                        </div>
                     </div>
                     <div class="col-lg-4">                         
                       <div class="form-group">
                     ...
                     <div class="col-lg-4">                         
                       <div class="form-group">
                        {{ Form::label('other_charges','Sms Charges (In Rs.)',['class'=>' control-label']) }}
            ...
            <div class="box-body">
              <table id="dataTable" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  <td>{{ $classfee->centers->name }}</td>
             
                  <td>{{ $classfee->sessions->date }}</td>
                  <td>{{ $classfee->classes->alias or '' }}</td>
                  <td>{{ array_sum(array_only(collect($classfee)->toArray(),['admission_fee','admission_form_fee','registration_fee','annual_fee','bus_fee','caution_fee','activity_charge','smart_fee','tution_fee','other_fee'])) }}</td>
                  <td align="center">
...
@endpush
 ...
 <script type="text/javascript">
     $(document).ready(function(){
        $('#dataTable').DataTable();        
     @if(@$section || $errors->first())
     $('#add_section').modal('show'); 
     @endif
      $('#center{{@$classFee->centers->id}}').attr('checked',true);
